...
exports.securityConfig = {
    trustProxyHops: env_config_1.ENV.TRUST_PROXY_HOPS,
    maxUrlLength: env_config_1.ENV.MAX_URL_LENGTH,
    requestTimeoutMs: env_config_1.ENV.REQUEST_TIMEOUT_MS,
    jsonBodyLimit: env_config_1.ENV.JSON_BODY_LIMIT,
    urlEncodedBodyLimit: env_config_1.ENV.URL_ENCODED_BODY_LIMIT,
    maxUploadSizeBytes: env_config_1.ENV.MAX_UPLOAD_SIZE_BYTES,
    redisUrl: env_config_1.ENV.REDIS_URL,
    rateLimits: {
        public: {
