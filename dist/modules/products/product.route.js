...
router.post("/", auth_middleware_1.authenticateUser, auth_middleware_1.requireAdmin, upload_middleware_1.productImageUpload, product_controller_1.productControllers.addProduct);
...
router.patch("/:id", auth_middleware_1.authenticateUser, auth_middleware_1.requireAdmin, upload_middleware_1.productImageUpload, product_controller_1.productControllers.updateProduct);
